...
const Dashboard = () => {
  ...
  const fetchComplaints = async () => {
    ...
    try {
      ...
      const response = await axios.get(`${API_BASE_URL}/api/admin/complaints`, {
        params,
      });
      if (response.data.success) {
  ...
  const departments = [
    ...new Set(complaints.map((c) => c.responsible_department).filter(Boolean)),
  ];

  if (loading) {
    return (
      <div className="dashboard-loading">
        {t("dashboardLoading") || "Loading dashboard..."}
      </div>
    );
  }
      ...
      {metrics && (
        <div className="metrics-grid">
          <div className="metric-card">
            ...
            <div className="metric-content">
              <span className="metric-label">
                {t("dashboardTotal") || "Total Complaints"}
              </span>
          ...
          <div className="metric-card">
            ...
            <div className="metric-content">
              <span className="metric-label">
                {t("dashboardInProgress") || "In Progress"}
              </span>
              <span className="metric-value">
                {metrics.by_status.in_progress}
              </span>
            </div>
          </div>
          ...
          <div className="metric-card escalated">
            ...
            <div className="metric-content">
              <span className="metric-label">
                {t("dashboardEscalated") || "Escalated"}
              </span>
              <span className="metric-value">
                {metrics.by_status.escalated}
              </span>
            </div>
          </div>
          ...
          <div className="metric-card sla-breach">
            ...
            <div className="metric-content">
              <span className="metric-label">
                {t("dashboardSLABreach") || "SLA Breaches"}
              </span>
              ...
              <div key={complaint.id} className="complaint-card">
                <div className="complaint-card-header">
                  <div className="complaint-id-section">
                    ...
                    <span className="complaint-id-value">
